  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<input readonly type ="text"  name="carmodel" value="Tata Tiago EV" class="form-control">
		</div>
		<div class="form-group">
		<label for="">Carnumber</label>
		<input readonly  type ="text"  name="carnumber" value="HR26DQ5551" class="form-control">
		</div>
