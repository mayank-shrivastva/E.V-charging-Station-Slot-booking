  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<input  readonly type ="text" name="station"  value ="Saraswat Motors Station( Lohvan)" class="form-control">
		</div>
		<div class="form-group">
		<label for=""> Name</label>
		<input readonly type ="text"  name="name" value="<?php echo $row['name'];?>" class="form-control">
		</div>
		<div class="form-group">
	...
	<input  readonly type ="email"  name="owner_email"  value="mayank.shrivastva_cs21@gla.ac.in" class="form-control">
		</div>
		
		<div class="form-group">
		<label for="">Vehical number</label>
		<input required  type ="text"  name="vnumber" class="form-control">
		</div>
