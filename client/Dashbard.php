<?php
    ...
    $query = mysqli_query($conn, "SELECT * FROM client WHERE email='{$_SESSION['SESSION_EMAIL']}'");
    ...
    <div id="main-wrapper">
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
				...
				<p class="brand-title" width="124px" height="33px"  style="font-size: 30px;">Client </p>
            </a>
					...
					<li class="dropdown header-profile">
						<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
							...
							<div class="header-info ms-3">
								<span class="font-w400 "><?php echo $row['owner name'];?></span>
							...
							<div class="card-body d-flex">
								...
								<div>
									<?php
																...
																$query ="SELECT id FROM s1 where owner_email='{$_SESSION['SESSION_EMAIL']}'  ORDER BY id";
								...
								?>
									<span class="text-white fs-18">No. of Booking today</span>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="card bg-success invoice-card">
							<div class="card-body d-flex">
								...
								<div>
									...
									<span class="text-white fs-18">No. of penals in station</span>
								</div>
							</div>
						</div>
					</div>
							...
							<div class="card-body d-flex">
								...
								<div>
										<?php
																...
																$query ="SELECT id FROM c1 where owner_email='{$_SESSION['SESSION_EMAIL']}'  ORDER BY id";
								 $query_run = mysqli_query($conn, $query);
								 $row = mysqli_num_rows($query_run);
					...
					<div class="col-xl-9 col-xxl-12">
						<div class="card">
							<div class="card-body">
									...
									<div class="col-xl-6">
										<div class="card-bx bg-blue">
											...
											<div class="card-info text-white">
												...
												<h4 class="text-white card-balance">Client</h4>
												<p class="fs-16">client@gmail.com</p>
								...
								?>
													<li><span class="bg-blue circle"></span>No. employee's <span>4</span></li>
													<li><span class="bg-success circle"></span>Number of station<span>2</span></li>
										 ...
										 <table class="table table-responsive-md card-table transactions-table">
											<tbody>
												<tr> 
													...
													<td>
														<h6 class="fs-16 text-black font-w600 mb-0">Customer Name</h6>
												...
												<?php  
									$sql="SELECT * FROM s1 WHERE owner_email='{$_SESSION['SESSION_EMAIL']}'";
